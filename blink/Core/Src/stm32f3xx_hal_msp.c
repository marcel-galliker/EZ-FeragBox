...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    GPIO_InitStruct.Pin = RS422_ENC_A_Pin|RS422_ENC_B_Pin;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, RS422_ENC_A_Pin|RS422_ENC_B_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, RS422_COM_TX_Pin|RS422_COM_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, UART_NUC_TX_Pin|UART_NUC_RX_Pin);
